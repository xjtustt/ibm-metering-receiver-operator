...
IMG ?= ibm-metering-receiver-operator
...
bundle:
	...
	-mkdir bundle
	rm -rf bundle/*
	cp -r deploy/olm-catalog/ibm-metering-receiver-operator/${CSV_VERSION}/* bundle/
	cp deploy/olm-catalog/ibm-metering-receiver-operator/ibm-metering-receiver-operator.package.yaml bundle/
